(function (window, undefined) {
    ...
    _pixie = {
        ...
        save: function(format, quality) {
            if (_pixie.loaded) {
                var pixieJSON = _pixie.getService('saver').getDataUrl('json');
                _pixie.getService('saver').saveImage(format, quality);
                document.getElementById("temp_data").innerHTML = pixieJSON;
                //console.log(pixieJSON);
            }
        },
        ...
        getPath: function() {
			...
			return 'http://dijivu.com/wp-content/themes/pubhtml-theme/pixie/';
        },
