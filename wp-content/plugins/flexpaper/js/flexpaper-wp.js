(function($) {
	$(document).ready(function() {
		...
		if(flex_opts.automaticconversion && flex_opts.automaticconversion != "false"){
            ...
            var base_dir = $(this).data('document').indexOf('http')==0?'':flex_opts.pdf_base_dir;
			...
			$(this).FlexPaperViewer(
	               { config : {
	                 ...
	                 PDFFile : ($(this).data('document').indexOf('.swf')>0)?$(this).data('document').substr(0,$(this).data('document').length-4) + '.pdf':base_dir+$(this).data('document'),
